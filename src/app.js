...
// CORS configuration
var corsOptions = {
    origin: ['http://localhost:3000', 'https://charlotte-webapp.vercel.app'],
    credentials: true,
...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'http://localhost:3000', 'https://charlotte-webapp.vercel.app');
