...
const AuthLayout = () => {
    ...
    return (
        status && <div className={`max-w-[60%] m-auto p-10 min-h-screen flex items-center justify-center bg-gray-50 ${styles.container}`}>
                ...
                <Spring className="max-w-[80%] w-full" type="slideUp" duration={400} delay={300}>
                    ...
                    <div className="my-10">
                        <div className="relative text-center">
                            ...
                            <span className="text-3xl relative bg-white px-4 text-gray-500">hoặc</span>
                        </div>
