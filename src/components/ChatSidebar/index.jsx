...
const ChatSideBar = () => {
    ...
    // };
    return (
        <nav className="bg-[#FAFAFA] text-black shadow-lg h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 flex-col">
            <div className="flex flex-wrap items-center cursor-pointer text-5xl">
                ...
                <div className="ml-6">
                    ...
                    <h6 className="text-lg text-black">John Doe</h6> {/* Updated size */}
                </div>
            </div>
            ...
            <div className="my-8 flex-1">
                <h6 className="text-xl text-black inline-block">Teams</h6> {/* Updated size */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" className="w-[15px] h-[15px] float-right cursor-pointer ml-auto" viewBox="0 0 118.783 118.783">
                ...
                <ul className="mt-6 space-y-6">
                    <li className="flex items-center text-lg text-gray-300 hover:text-white cursor-pointer"> {/* Updated size */}
                        <span className="relative inline-block mr-4">
                            <img src='https://readymadeui.com/profile_3.webp' className="w-10 h-10 p-1 rounded-full border-2 border-gray-300" />
                            <span className="h-3 w-3 rounded-full bg-green-600 block absolute bottom-1 right-0"></span>
                        </span>
                        Peter Taylor
                        <span className="bg-red-500 min-w-[20px] min-h-[20px] px-1 flex items-center justify-center text-white text-[11px] font-bold rounded-full ml-auto">1</span>
                    </li>
                    <li className="flex items-center text-lg text-gray-300 hover:text-white cursor-pointer"> {/* Updated size */}
                        <span className="relative inline-block mr-4">
                        ...
                        Johne Words
                        <span className="bg-red-500 min-w-[20px] min-h-[20px] px-1 flex items-center justify-center text-white text-[11px] font-bold rounded-full ml-auto">5</span>
                    </li>
                    <li className="flex items-center text-lg text-gray-300 hover:text-white cursor-pointer"> {/* Updated size */}
                        <span className="relative inline-block mr-4">
                    ...
                    <li className="flex items-center text-lg text-gray-300 hover:text-white cursor-pointer"> {/* Updated size */}
                        ...
                        Ammie Kolhe
                        <span className="bg-red-500 min-w-[20px] min-h-[20px] px-1 flex items-center justify-center text-white text-[11px] font-bold rounded-full ml-auto">2</span>
                    </li>
                    <li className="flex items-center text-lg text-gray-300 hover:text-white cursor-pointer"> {/* Updated size */}
                        <span className="relative inline-block mr-4">
